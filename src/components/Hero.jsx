  ...
  return (
    <div className='bg-black text-white text-center py-20'>
       ...
       <h1 className='text-5xl font-bold'>
         I am {" "}
         <span className='text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-500'>Md Saquib Anwar</span>,
          Full Stack Devloper
         
       </h1>
       <p className='mt-4 text-lg text-gray-300'> I specialize in building modern and responsive web appliction.</p>
